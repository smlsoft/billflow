...
> Scope ปัจจุบัน: ดึงอีเมล Shopee/Lazada ฝั่งบิลซื้อ, ตรวจรายการ, จับคู่สินค้า, เลือกผู้ขาย/คลัง/ภาษี, เก็บวิธีชำระเงินใน BillFlow เมื่อจำเป็น, และส่งเข้า SML `purchaseorder`
...
| วิธีการชำระเงิน | ❌ ไม่บังคับส่ง SML | เก็บใน BillFlow เท่านั้น ไม่ส่งเข้า SML; ถ้าผู้ขายเป็น `TTxxxx` ระบบเลือกและล็อกให้เอง |
...
- สำหรับ Shopee/Lazada purchase email ไม่ต้องเลือก `วิธีการชำระเงิน` เพื่อส่ง SML; ถ้าผู้ขายเป็น `TTxxxx` ระบบบันทึกค่า TT นั้นใน BillFlow ให้เอง และไม่ส่งค่านี้เข้า SML.
