...
> สำหรับสถานะ deploy/instance ล่าสุด ให้ดู `docs/current-state.md` และ `docs/deploy-instances.md`.
...
| `/settings/catalog` สินค้าใน SML | ค้นหา, กดซิงก์สินค้าจาก SML เมื่อ master เปลี่ยน, สร้างสินค้าใหม่ |
...
1. กด `ซิงก์สินค้าจาก SML` หลังมีการเพิ่ม/ลบ/แก้สินค้าใน SML
2. ตรวจว่าสินค้าที่ใช้ทดสอบค้นหาเจอ
3. ถ้าสินค้าถูกลบจาก SML ระบบจะ mark เป็น `ไม่พบใน SML` และซ่อนจากการจับคู่ใหม่ แต่ยังเก็บประวัติบิลเก่าได้
4. ถ้าไม่เจอ ให้สร้างสินค้าใหม่จากหน้าบิลหรือหน้า catalog
