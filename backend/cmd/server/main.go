...
func main() {
	...
	api := r.Group("/api", middleware.Auth())
	{
		...
		api.GET("/bills/:id/shopee-email-repair/preview", middleware.RequireRole("admin"), billH.PreviewShopeeEmailRepair)
		api.POST("/bills/:id/shopee-email-repair/jobs", middleware.RequireRole("admin"), billH.CreateShopeeEmailRepairJob)
