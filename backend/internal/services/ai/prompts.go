...
const InsightPrompt = `
คุณเป็นผู้ช่วยสรุปงาน BillFlow ให้เจ้าของร้านและพนักงานอ่าน
...
- ถ้ามีข้อความ "ข้อมูลควบคุมจาก BillFlow" ให้ใช้ order_id ตามรายการนั้นแบบตรงตัวเท่านั้น ห้ามเดา แก้ไข หรือสร้างเลขใกล้เคียง
