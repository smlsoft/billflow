...
type Bill struct {
	...
	PrintPaymentMethod          string             `json:"print_payment_method"`
	EffectivePrintPaymentMethod string             `json:"effective_print_payment_method"`
...
type EmailPrintEvent struct {
	...
	CreatedAt         time.Time `json:"created_at"`
	RelatedOrderCount int       `json:"related_order_count,omitempty"`
	SMLDocCount       int       `json:"sml_doc_count,omitempty"`
}
...
const (
	ShopeeShippingSourceSKU = "__shopee_shipping__"
	LazadaFeeSourceSKU      = "__lazada_shipping_fee__"
)

func IsMarketplaceFeeSourceSKU(sourceSKU string) bool {
	switch sourceSKU {
	case ShopeeShippingSourceSKU, LazadaFeeSourceSKU:
		return true
	default:
		return false
	}
...
type EmailPrintCandidate struct {
	MessageID        string                     `json:"message_id"`
	GroupKey         string                     `json:"group_key"`
	Subject          string                     `json:"subject,omitempty"`
	From             string                     `json:"from,omitempty"`
	ArtifactBillID   string                     `json:"artifact_bill_id"`
	ArtifactID       string                     `json:"artifact_id"`
	ArtifactFilename string                     `json:"artifact_filename"`
	Orders           []EmailPrintCandidateOrder `json:"orders"`
	PrintPolicy      MarketplacePrintPolicy     `json:"print_policy"`
	PrintPolicyNote  string                     `json:"print_policy_note"`
}
